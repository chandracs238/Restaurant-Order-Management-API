...
public class OrderController {
    ...
    @PostMapping
    public ResponseEntity<?> createOrder(@RequestParam Long userId, @RequestBody OrderDto orderDto) throws AccessDeniedException {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(orderService.createCustomerOrder(userId, orderDto));
    }

    @GetMapping("{orderId}")
    public ResponseEntity<?> getOrderById(@PathVariable Long orderId, @RequestParam Long userId) throws AccessDeniedException {
        return ResponseEntity.ok(orderService.getCustomerOrderById(userId,orderId));
    }
    ...
    public ResponseEntity<?> deleteOrderById(@RequestParam Long userId, @PathVariable Long orderId) throws AccessDeniedException {
